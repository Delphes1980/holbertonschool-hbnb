    ...
    def post(self):
        ...
        try:
            ...
            if given_user_id is None:
                ...
                raise CustomError('Unauthorized action: authenticated user does not match provided review author', 403)
            ...
            if place.owner.id == current_user:
                raise CustomError('User can not review their own place', 400)
